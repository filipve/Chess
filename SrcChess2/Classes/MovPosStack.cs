    ...
    public class MovePosStack : IXmlSerializable {
        ...
        void IXmlSerializable.WriteXml(System.Xml.XmlWriter writer) {
            ...
            foreach (ChessBoard.MovePosS movePos in m_listMovePos) {
                ...
                writer.WriteAttributeString("OriginalPiece",     ((ChessBoard.SerPieceE)movePos.OriginalPiece).ToString());
                writer.WriteAttributeString("StartingPosition",  ((int)movePos.StartPos).ToString());
                writer.WriteAttributeString("EndingPosition",    ((int)movePos.EndPos).ToString());
                writer.WriteAttributeString("MoveType",          movePos.Type.ToString());
